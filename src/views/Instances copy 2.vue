...
export default {
    ...
    methods:{
        initGetDataList() {
            ...
            this.nowGetDataListData.type = this.instnaceType? this.instnaceType: 'Data'
            this.nowGetDataListData.uid = this.listUid
            if(!this.nowGetDataListData.parentLevel) this.nowGetDataListData.parentLevel = '-1'
            ...
            if(res.data.code==0){
                ...
                if(_this.currentPcs.type=='Visualization'){
                    if(res.data.html){
                        ...
                        window.open('http://111.229.14.128:8898/data?uid=' +res.data.uid,"VisualResultResultHtml",'width=700,height=600,resizable=yes,scrollbars=yes')
                        
                    }else{
                        this.$alert('<img src='+'http://111.229.14.128:8898/data?uid=' +res.data.uid+' width="100%" height="100%" alt="Visualization Result" />', 'Visualization Result', {
                     ...
                     window.location.href='http://111.229.14.128:8898/data?uid=' +res.data.uid
